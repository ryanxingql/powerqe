...
data = dict(
    train=dict(dataset=dict(pipeline=train_pipeline, samp_len=3, center_gt=center_gt)),
    val=dict(pipeline=test_pipeline, samp_len=3, center_gt=center_gt),
    test=dict(pipeline=test_pipeline, samp_len=3, center_gt=center_gt),
)
