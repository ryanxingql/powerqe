...
You can find QP, IntraQPOffset, QPoffset, QPOffsetModelOff, and QPOffsetModelScale in the configuration, i.e., data/hm/cfg/encoder_lowdelay_P_main.cfg. In addition, you can find the frame QPs in log files. How do QP, IntraQPOffset, QPoffset, QPOffsetModelOff, and QPOffsetModelScale determine the frame QPs?
